...
import NavActiveMarker from "@/components/NavActiveMarker";
            ...
            <body className={`${openSans.variable} ${outfit.variable} font-body bg-night-950 text-slate-100 min-h-screen antialiased selection:bg-moon selection:text-night-950`}>
                <ClientProviders>
                    ...
                    <header className="fixed top-0 left-0 right-0 z-50 border-b border-white/10 bg-[#111827]/88 backdrop-blur-xl">
                        <div className="container-custom py-3 flex items-center justify-center md:justify-between">
                            ...
                            <nav className="hidden md:flex items-center gap-1 rounded-2xl border border-white/10 bg-white/[0.045] p-1 font-medium text-sm taste-surface">
                                <a href="/" data-nav-match="/" className="site-nav-link rounded-xl px-3 py-2 text-slate-300 transition-colors hover:text-white hover:bg-white/[0.055]">Acasă</a>
                                <a href="/azi" data-nav-match="/azi" className="site-nav-link rounded-xl px-3 py-2 text-slate-300 transition-colors hover:text-white hover:bg-white/[0.055]">Solunar Azi</a>
                                <a href="/lunar" data-nav-match="/lunar" className="site-nav-link rounded-xl px-3 py-2 text-slate-300 transition-colors hover:text-white hover:bg-white/[0.055]">Faze Lunare</a>
                                <a href="/locuri-pescuit" data-nav-match="/locuri-pescuit" className="site-nav-link rounded-xl px-3 py-2 text-slate-300 transition-colors hover:text-white hover:bg-white/[0.055]">Locuri Pescuit</a>
                                <a href="/blog" data-nav-match="/blog" className="site-nav-link rounded-xl px-3 py-2 text-slate-300 transition-colors hover:text-white hover:bg-white/[0.055]">Ghiduri</a>
                                <a href="/despre" data-nav-match="/despre" className="site-nav-link rounded-xl px-3 py-2 text-slate-300 transition-colors hover:text-white hover:bg-white/[0.055]">Despre</a>
                            </nav>
                        </div>
                    </header>
                    ...
                    <nav className="mobile-bottom-nav fixed bottom-3 left-3 right-3 z-50 bg-[#111827]/92 backdrop-blur-xl border border-white/10 rounded-2xl flex items-center justify-around py-2 px-3 taste-surface md:hidden">
                        <a href="/" data-nav-match="/" className="site-nav-link flex min-w-0 flex-1 flex-col items-center gap-0.5 rounded-xl py-1.5 text-[10px] text-slate-400 transition-colors hover:bg-white/[0.055] hover:text-white">
                        ...
                        <a href="/azi" data-nav-match="/azi" className="site-nav-link flex min-w-0 flex-1 flex-col items-center gap-0.5 rounded-xl py-1.5 text-[10px] text-slate-400 transition-colors hover:bg-white/[0.055] hover:text-white">
                            <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" /></svg>
                            Azi
                        </a>
                        <a href="/locuri-pescuit" data-nav-match="/locuri-pescuit" className="site-nav-link flex min-w-0 flex-1 flex-col items-center gap-0.5 rounded-xl py-1.5 text-[10px] text-slate-400 transition-colors hover:bg-white/[0.055] hover:text-white">
                            <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" /><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" /></svg>
                            Locuri
                        </a>
                        <a href="/blog" data-nav-match="/blog" className="site-nav-link flex min-w-0 flex-1 flex-col items-center gap-0.5 rounded-xl py-1.5 text-[10px] text-slate-400 transition-colors hover:bg-white/[0.055] hover:text-white">
