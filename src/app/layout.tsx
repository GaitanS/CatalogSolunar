                ...
                <ClientProviders>
                    ...
                    <div className="container-custom py-4 flex items-center justify-between">
                        <a href="/" className="flex items-center gap-2 group">
                            <svg className="w-8 h-8 text-moon group-hover:scale-110 transition-transform" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <div className="container-custom grid md:grid-cols-4 gap-8">
                        <div className="md:col-span-2">
                            <div className="flex items-center gap-2 mb-4">
                                <svg className="w-6 h-6 text-moon" fill="currentColor" viewBox="0 0 24 24">
                                    <path d="M20.354 15.354A9 9 0 018.646 3.646 9.003 9.003 0 0012 21a9.003 9.003 0 008.354-5.646z" />
                                </svg>
