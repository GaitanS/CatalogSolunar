        ...
        <html lang="ro">
            ...
            <body className={`${openSans.variable} ${robotoSlab.variable} font-body bg-night-950 text-slate-100 min-h-screen antialiased selection:bg-moon selection:text-night-950`}>
                <ClientProviders>
                    ...
                    {/* Mobile bottom navigation — 98.5% of traffic is mobile */}
                    <nav className="md:hidden fixed bottom-0 left-0 right-0 z-50 bg-night-950/95 backdrop-blur-md border-t border-night-800 flex items-center justify-around py-2 px-4">
                        <a href="/" className="flex flex-col items-center gap-0.5 text-[10px] text-night-400 hover:text-white transition-colors">
                        ...
                        <a href="/azi" className="flex flex-col items-center gap-0.5 text-[10px] text-night-400 hover:text-white transition-colors">
                            <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" /></svg>
                            Azi
                        </a>
                        <a href="/locuri-pescuit" className="flex flex-col items-center gap-0.5 text-[10px] text-night-400 hover:text-white transition-colors">
                            <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" /><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" /></svg>
                            Locuri
                        </a>
                        <a href="/blog" className="flex flex-col items-center gap-0.5 text-[10px] text-night-400 hover:text-white transition-colors">
